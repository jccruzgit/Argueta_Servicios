...
from ArguetaServicios.views import CreatePrecio, ListPrecios, UpdatePrice
from ArguetaServicios.views import facturas, DetalleFactura, facturaiva, Upload_file, Download, grafica, ReportePersonasPDF
