...
urlpatterns = [
    ...
    url(r'^recepcion/', include('recepcion.urls')),  # App recepcion
    url(r'^ArguetaServicios/', include('ArguetaServicios.urls')),  # App facturacion y reportes
    url(r'^chaining/', include('smart_selects.urls')),
    url(r'^accounts/login/', LoginClass.as_view(), name='login'),
    url(r'^email/', send_email, name="send"),

    url(r'^registration/password_reset', PasswordResetView.as_view(),{'subject_template_name': 'registration/password_reset_form.html',
    ...
    url(r'^registration/done', PasswordResetCompleteView.as_view(),{'template_name': 'registration/password_reset_complete.html'}, name='password_reset_complete'),
