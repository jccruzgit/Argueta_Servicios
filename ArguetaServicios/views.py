...
from django.http import HttpResponse, JsonResponse, HttpResponseRedirect, BadHeaderError
...
from ArguetaServicios.forms import CrearPrecioForm
from ArguetaServicios.models import Precio, Documentos
from recepcion.models import Empresa, Ficha, Agenda, Profile, Evaluador
...
class CreatePrecio(PassRequestMixin, SuccessMessageMixin, CreateView):
    ...
    success_url = reverse_lazy('arguetaservicios:precios')
...
def Upload_file(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            subject = "Nuevo Informe Psicológico"
            message = "Informe Psicológico de "+newdoc.nombre+" ha sido agregado al sistema"
            ...
            print(usuario.email)
            from_email = "arguetaservicios123@gmail.com"
